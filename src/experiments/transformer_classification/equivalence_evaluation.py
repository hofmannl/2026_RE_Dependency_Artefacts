...
from relationship_analysers_classifier.relationship_analysers.semantical_equivalence_analyser.transformer_equivalence_approach import SemanticEquivalenceAnalyserTransformer
...
### Personas
m: SemanticEquivalenceAnalyserTransformer = SemanticEquivalenceAnalyserTransformer(TypeGraphUs.PERSONA)
...
print_or_log(
    f"Semantical Equivalence Analyser Transformer | {file_name} | Persona pairs | Threshold {threshold} | {end_time - start_time} seconds",
...
save_results_to_csv(
    current_file.parents[0] / f"{file_name}_semantical_equivalence_persona_threshold_{threshold}.csv", 
    total_results, 
...
### Actions
m = SemanticEquivalenceAnalyserTransformer(TypeGraphUs.ACTION)
...
print_or_log(
    f"Semantical Equivalence Analyser Transformer | {file_name} | Action pairs | Threshold {threshold} | {end_time - start_time} seconds",
    file_name=f"{file_name}",
    file_path=current_file.parents[0],
    log=input_print_or_log
)
save_results_to_csv(
    current_file.parents[0] / f"{file_name}_semantical_equivalence_action_threshold_{threshold}.csv", 
    total_results, 
...
### Entities
m = SemanticEquivalenceAnalyserTransformer(TypeGraphUs.ENTITY)
...
print_or_log(
    f"Semantical Equivalence Analyser Transformer | {file_name} | Entity pairs | Threshold {threshold} | {end_time - start_time} seconds",
    file_name=f"{file_name}",
    file_path=current_file.parents[0],
    log=input_print_or_log
)
save_results_to_csv(
    current_file.parents[0] / f"{file_name}_semantical_equivalence_entity_threshold_{threshold}.csv", 
    total_results, 
